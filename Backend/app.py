...
class Analyse:
    def __init__(self, pair, granularity,user_strategy, forward_return = 10, start_date='2015-10', end_date='2016-01'):
        ...
        self.dataModule = LoadData('Config/oanda.cfg')
    ...
    def run_engine(self):
        ...
        self.stats.get_stats(strategy_return)
        self.stats.statistical_tests(strategy_return, processed_data)
        self.stats.bootstrap_resampling(strategy_return)
        self.performance.winloss_rate(strategy_return)
        self.performance.yearly(processed_data, strategy_return)
        self.performance.column(processed_data, strategy_return)
